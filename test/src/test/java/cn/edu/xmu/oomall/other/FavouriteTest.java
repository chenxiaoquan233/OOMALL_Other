...
public class FavouriteTest {
    ...
    private String mallGate="http://localhost:9999";
    ...
    private String login() throws Exception{
        return login("19769355952","123456");
    }
    ...
    * 此时不应插入新收藏，应将原重复收藏返回*/
    ...
    /*添加skuId格式不正确的收藏
    * 根据通用错误处理，返回400，errno为0，errmsg自定义*/
    @Test
    ...
    /* 正常删除收藏*/
    @Test
    public void FavoriteTestX() throws Exception{
        String token = login();
    ...
    /* 删除不存在的收藏
    * 根据通用错误处理，返回404，errno为0，errmsg自定义*/
    @Test
    public void FavoriteTestXX() throws Exception{
        String token = login();
        mallClient.delete().uri("/favorites/3735448").header("authorization",token)
                .exchange()
