...
public class AdvertiseController {
    ...
    public Object updateAdvertisementById(@LoginUser Long user, @PathVariable("id") Long id, @Validated @RequestBody AdvertiseVo advertiseVo, BindingResult bindingResult){
